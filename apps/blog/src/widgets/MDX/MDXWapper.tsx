...
export const MDXWapper = ({ children, className }: { children: React.ReactNode; className?: string }) => (
  <div
    className={cn(
      ...
      "prose-inline-code:inline-block prose-inline-code:px-1 prose-inline-code:font-normal prose-inline-code:relative prose-inline-code:-top-[0.125rem] prose-inline-code:bg-zinc-100 prose-inline-code:text-secondary-lg prose-inline-code:rounded-md prose-inline-code:shadow-md dark:prose-inline-code:shadow-zinc-800 dark:prose-inline-code:bg-zinc-900 dark:prose-inline-code:text-secondary-md",
      ...
      "prose-code:text-[0.725rem] prose-p:mb-8",
      " prose-th:text-start",
      className
    )}
  >
